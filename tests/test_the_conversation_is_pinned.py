...
FIXED SINCE, each by its own issue, and each flipped test says so in its docstring: a typed "não" is
recorded as a no, in the durable store and in the intake case (#272); a refused "funcionou" on a
release leaves the release question open for somebody who may answer it (#273); an expired
