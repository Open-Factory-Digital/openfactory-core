...
the line it depends on; 146 rows, every one red against this file (2026-09-24, after #266 slice 4)
— 145 since #266 slice 6 retired the one that cut the vendor's event parser the core no longer
has.
"""
