...
class _Room(_Module):
    ...
    def answer(self, question, *, speaker=None, private=False, now="", **kw):
        # `private` (#267 slice 2) and `now` (#335) are the engine's to hand over and this
        # double's to ignore: the base double predates them, and forwarding them would be
