...
| [0052](0052-the-owners-view.md) | The owner's view: one read model of the product for the panel and the role, minus an explicit exclusion list that starts with spend; a briefing with source and age in every turn; events through the door, told in the conversation's queue | Proposed (design only) |
