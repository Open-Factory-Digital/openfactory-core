...
__all__ = ["ContainerSandbox", "SandboxAdapter", "Workspace", "WorktreeSandbox"]

_LAZY = {
    'ContainerSandbox': 'openfactory.adapters.sandbox.container',
    'WorktreeSandbox': 'openfactory.adapters.sandbox.worktree',
}
